...
Oto.Age.Model.fits<-function(spp.dat.in,oto.age.col=c(5,4),sextype="All",Bp.find="F",rngSplit=c(10,200),steppin=10,breakpts,lowbreaks=c(0,0,0),intcpt="Y",CG="F",jitter=0,one.to.one="F")
{
  #Data prep
